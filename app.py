    ...
    gr.HTML(
        f"""
            <div class="finetuned-diffusion-div">
              <div>
                <h1>All Models Diffusion</h1>
              </div>
              <p>
               Demo for multiple fine-tuned Stable Diffusion models, trained on different styles: <br>
               Arcane,Archer,Elden Ring, Spider-Verse, Modern Disney, Classic Disney, Loving Vincent (Van Gogh), Redshift renderer (Cinema4D), Midjourney v4 style, Waifu, Pokémon, Pony Diffusion, Robo Diffusion, Cyberpunk Anime, Tron Legacy, Balloon Art Diffusers 🧨 SD model hosted on HuggingFace 🤗.
              </p>
            </div>
        """
    )
